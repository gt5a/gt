function move() {
	...
	var lootbox2 = document.getElementById("lootbox2").value;
	if(username=="") {
		alert('Please insert your GTA 5 username');
		return false;
	}
	...
	function frame() {
		...
		if (width > 10 && width < 20) {
			document.getElementById("progresslog").innerHTML = "Connecting to Rockstar server";
		}
		...
		if (width > 60 && width < 70) {
			document.getElementById("progresslog").innerHTML = "Adding selected amount of Money: "+lootbox+" and RP: "+lootbox2+" ";
		}

		if (width > 80 && width < 90) {
			document.getElementById("progresslog").innerHTML = "Selected amount of Money: "+lootbox+" and RP: "+lootbox2+" ready to be added";
		}
